...
var SvgIcon = React11.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React11.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
  ...
  return (0, import_jsx_runtime5.jsxs)(SvgIconRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
...
//# sourceMappingURL=chunk-JUBIVWVS.js.map
